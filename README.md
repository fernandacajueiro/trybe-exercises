...
This repository contains all learning activities developed by _[Fernanda Cajueiro](https://www.linkedin.com/in/fernandacajueiro/)_ while studying at Trybe 🚀

_"TTrybe is a school for people who want to build a successful career in the technology area and it's fully committed to its students because they only pay for the course after getting a good job."_

The program has more than 1.500 hours of in-person and online classes and deals with software development introduction, front-end, back-end, computer science, software engineering, agile methodologies and behavioral skills.
...
- [ ] 18-2: _React Hooks - useState & useContext_
- [ ] 18-3: _React Hooks - useEffect & Hooks customizados_
- [ ] 18-4: _[Project - StarWars Datatable with Context API & Hooks]()_
...
- [ ] 28-2: _Web Architecture - Rest & Restful_
- [ ] 28-3: _[Project - Store Manager]()_

##### Block 29: NodeJS

- [ ] 29-1: _NodeJS - JWT - (JSON Web Token)_
- [ ] 29-2: _NodeJS - Multer files upload_
...
- [ ] 32-4: _Best coding practices in tests writing_
...
- [ ] 35-1: _Learning about Python_
- [ ] 35-2: _Tests and exceptions_
- [ ] 35-3: _Entry and exit data_
- [ ] 36-4: _Entry and exit data_
